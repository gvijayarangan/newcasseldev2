...
class ResidentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('residents')->insert([
            ...
            'res_email' => 'kenn@gmail.com', 'res_comment' => 'No entry without premission', 'res_status' => 'Active', 'res_apt_id' => 101 , 'res_cntr_id' => ($center = Center::where('cntr_name', '=', '90th')->first()->id) ,
        ]);
        DB::table('residents')->insert([
        ...
        DB::table('residents')->insert([
            ...
            'res_email' => 'Billy@gmail.com', 'res_comment' => 'Call before entry', 'res_status' => 'Active', 'res_apt_id' => 101 , 'res_cntr_id' => ($center = Center::where('cntr_name', '=', '90th')->first()->id) ,
        ]);
        DB::table('residents')->insert([
            ...
            'res_email' => 'Emily@gmail.com', 'res_comment' => 'Entry after 4:00 PM', 'res_status' => 'Active', 'res_apt_id' => 101 , 'res_cntr_id' => ($center = Center::where('cntr_name', '=', '90th')->first()->id) ,
        ]);
        DB::table('residents')->insert([
            ...
            'res_email' => 'Joe@gmail.com', 'res_comment' => 'Entry before noon', 'res_status' => 'Active', 'res_apt_id' => 101 , 'res_cntr_id' => ($center = Center::where('cntr_name', '=', '90th')->first()->id) ,
        ]);
