                        ...
                        <div class="pull-right">
                            <form action="{{ url('/resident/create') }}" method="GET">{{ csrf_field() }}
                                <button type="submit" id="create-user" class="btn btn-primary"><i
                                            class="fa fa-btn fa-file-o"></i>Create Resident
                                </button>
                            </form>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach ($createres as $createres)
                                    <tr>
                                        ...
                                        <td><a href="{{url('resident',$createres->id)}}"
                                               class="btn btn-primary">View</a></td>
                                        <td><a href="{{url('resident/update',$createres->id)}}" class="btn btn-warning">Modify</a>
                                        </td>
                                        <td>
