                    ...
                    <div class="panel-body" style="padding-left: 15%">
                        ...
                        <div.panel-heading class="col-sm-4">
                            {!! Form::text('requestor_name',$wo_edit_data->requestor_name,
                             array('id' => 'requestername','readonly' => 'true')) !!}
                        </div.panel-heading>
                        </br> </br>
                        ...
                        <div.panel-heading class="col-md-8">
                            <div class="form-group">
                                {{ Form::select('cntr_name', array_merge([0 => '']) + $centers, $wo_edit_data->cntr_id,
                                 array('id' => 'center_dropdown', 'class' => 'col-md-4','disabled' => 'true')) }}
                            </div>
                        </div.panel-heading>
                        </br> </br>
                        ...
                        <div.panel-heading class="col-md-8">
                            ...
                            array('id' => 'apartment_dropdown', 'class' => 'col-md-4','disabled' => 'true')) }}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-8">
                            ...
                            array('id' => 'residentname_dropdown', 'class' => 'col-md-4','disabled' => 'true')) }}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-8">
                            ...
                            array('id' => 'commonarea_dropdown', 'class' => 'col-md-4','disabled' => 'true')) }}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-8">
                            {!! Form::select('order_priority', ['0' => '', 'Low' => 'Low', 'Moderate' => 'Moderate', 'High' => 'High'],
                               $wo_edit_data->order_priority, array('class' => 'col-md-4','disabled' => 'true')) !!}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-4">
                            ...
                            array('id' => 'issuetype_dropdown','disabled' => 'true')) }}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-8">
                            {!! Form::text('issuedescription',$issue_description, array('id' => 'issuedescription',
                        ...
                        <div.panel-heading class="col-md-8">
                            {!! Form::text('order_description',$wo_edit_data->order_description,['class'=>'form-control','readonly'=>true]) !!}
                        </div.panel-heading>
                        ...
                        <div.panel-heading class="col-md-6">
                            {{ Form::select('assign_user_id', array_merge([0 => '']) + $workers, $assignto,
                             array('id' => 'assigntype_dropdown','class' => 'col-md-6','disabled' => 'true')) }}
                        </div.panel-heading>
                        ...
                        <div.panel-heading style="padding-left: 15px">
                            ...
                            array('id' => 'tools_data', 'multiple'=>'multiple', 'style' =>'width:75%','disabled'=>true)) }}
                        </div.panel-heading>
