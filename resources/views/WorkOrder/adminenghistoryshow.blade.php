        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading"> WorkOrder History Information</div>
                    @if (count($errors) > 0)
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {!! Form::text('requestor_name',$wo_edit_data->requestor_name,
                             array('id' => 'requestername','readonly' => 'true','class'=>'form-control input-sm')) !!}
                        </div>
                        </br> </br>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            <div class="form-group">
                                {{ Form::select('cntr_name', array_merge([0 => '']) + $centers, $wo_edit_data->cntr_id,
                                 array('id' => 'center_dropdown', 'class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) }}
                            </div>
                        </div>
                        </br> </br>
                        {!! Form::label('apartment no', 'Apartment No:', ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {{ Form::select('apt_id', array_merge([0 => '']) + $apartments, $wo_edit_data->apt_id,
                            array('id' => 'apartment_dropdown', 'class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) }}
                        </div>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {{ Form::select('residentname', array_merge([0 => '']) + $residents , $wo_edit_data->resident_id,
                            array('id' => 'residentname_dropdown', 'class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) }}
                        </div>

                        </br> </br>
                        {!! Form::label('commonarea', 'Common Area/System:', ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {{ Form::select('ca_id', array_merge([0 => '']) + $commonarea , $wo_edit_data->ca_id,
                            array('id' => 'commonarea_dropdown', 'class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) }}
                        </div>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            @if($user->hasRole('admin'))
                                {!! Form::select('order_status', ['' => '','Open' => 'Open','In Progress' => 'In Progress',
                                  ...
                                  $wo_edit_data->order_status, array('class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) !!}
                            @else
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {!! Form::select('order_priority', ['0' => '', 'Low' => 'Low', 'Moderate' => 'Moderate', 'High' => 'High'],
                               $wo_edit_data->order_priority, array('class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) !!}
                        </div>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {{ Form::select('issuetype', array_merge([0 => '']) + $issuetypes, $wo_edit_data->issue_type,
                            array('id' => 'issuetype_dropdown','disabled' => 'true','class' => 'col-md-offset-3 col-md-6 col-md-pull-3')) }}
                        </div>
                        ...
                        <div class="col-md-offset-1 col-md-8 col-md-pull-1">
                            {!! Form::text('order_description',$wo_edit_data->order_description,
                            ['class'=>'form-control col-md-offset-1 col-md-8 col-md-pull-1','readonly']) !!}
                        </div>
                        ...
                        <div class="col-md-offset-3 col-md-6 col-md-pull-3">
                            {{ Form::select('assign_user_id', array_merge([0 => '']) + $workers, $assignto,
                             array('id' => 'assigntype_dropdown','class' => 'col-md-offset-3 col-md-6 col-md-pull-3','disabled' => 'true')) }}
                        </div>
                        ...
                        <div class="col-md-offset-1 col-md-8 col-md-pull-1">
                            ...
                            array('id' => 'tools_data', 'multiple'=>'multiple', 'class'=>'col-md-offset-1 col-md-8 col-md-pull-1','disabled'=>true)) }}
                        </div>
