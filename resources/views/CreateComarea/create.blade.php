                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            {!! Html::decode(Form::label('cntr_id', '<span style="color: red;">*</span>Center Name:',['class' => 'col-md-4 control-label'])) !!}
                            <div class="col-md-4">
                                {{ Form::select('cntr_id', array_merge([0 => 'Please Select']) + $centers, 'default',
                                array('id' => 'center_dropdown','required' => 'required')) }}
                            </div>
                            </br> </br>
                            {!! Html::decode(Form::label('ca_name', '<span style="color: red;">*</span>Common Area/System name:',['class' => 'col-md-4 control-label'])) !!}
                            <div class="col-md-4">
